...
//    static Enemies enemies = new Enemies();
    ...
    public void randomTypeOfEnemy(Enemies enemy) {
        Random aleatorio = new Random();
        int value = aleatorio.nextInt(3);

        switch (0) {
            case 0:
                enemy.minorEnemyStatus();
                JOptionPane.showMessageDialog(null, "Você encontrou o " + enemy.minorEnemyStatus().getEnemyName());
                break;
            case 1:
                enemy.mediumEnemyStatus();
                JOptionPane.showMessageDialog(null, "Você encontrou o " + enemy.mediumEnemyStatus().getEnemyName());
                break;
            case 2:
                enemy.greatEnemyStatus();
                JOptionPane.showMessageDialog(null, "Você encontrou o " + enemy.greatEnemyStatus().getEnemyName());
                break;
